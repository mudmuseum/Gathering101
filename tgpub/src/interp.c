...
const	struct	cmd_type	cmd_table	[] =
{
    ...
    { "info",      	do_info,   	POS_DEAD,        10,  LOG_NORMAL },
     ...
     */
    { "affects",  	do_affect,      POS_DEAD,        0, LOG_NORMAL },
    ...
    { "finger",		do_finger,	POS_SITTING,	 0,  LOG_ALWAYS	},
    ...
    { "learn", 		do_learn,	POS_MEDITATING,  4,  LOG_NORMAL },
    { "level",		do_level,	POS_MEDITATING,	 0,  LOG_NORMAL },
    ...
    { "unique",		do_unique,	POS_STANDING,	 0,  LOG_NORMAL },
...
*/
     ...
     */
    { "answer",		do_answer,	POS_SLEEPING,	 2,  LOG_NORMAL },
    { "board", 		do_board,	POS_DEAD,	 0,  LOG_NORMAL },
    { "chat",		do_chat,	POS_DEAD,	 2,  LOG_NORMAL	},
    { ".",		do_chat,	POS_DEAD,	 2,  LOG_NORMAL	},
    { "decline",	do_decline,	POS_DEAD,	 0,  LOG_NORMAL },
    ...
    { "question",	do_question,	POS_SLEEPING,	 2,  LOG_NORMAL },
    ...
    { "talk",		do_talk,	POS_DEAD,	 0,  LOG_NORMAL },
    { "talkchannels",	do_talkchannels,POS_DEAD,	 0,  LOG_NORMAL },
...
//    { ">",		do_classtalk,	POS_DEAD,	 1,  LOG_NORMAL	},
    ...
    { "reclaim",	do_reclaim,	POS_STANDING,	 3,  LOG_ALWAYS },
    ...
    { "birth",		do_birth,	POS_STANDING,	 1,  LOG_ALWAYS	},
    ...
    { "bridge", 	do_bridge,	POS_STANDING,	 3,  LOG_NORMAL },
    ...
    { "fetish", 	do_fetish,	POS_STANDING,	 3,  LOG_ALWAYS },
    ...
    { "train",		do_train,	POS_SITTING,	 0,  LOG_ALWAYS	},
    ...
    { "demonarmour",	do_demonarmour,	POS_STANDING,	 3,  LOG_ALWAYS	},
    { "evileye",      	do_evileye,   	POS_SITTING,     3,  LOG_NORMAL },
    { "fangs",		do_fangs,	POS_SITTING,	 3,  LOG_NORMAL	},
    { "favour",		do_favour,	POS_SITTING,	 3,  LOG_NORMAL	},
    { "feed",		do_feed,	POS_SITTING,	 3,  LOG_NORMAL	},
    { "fire", 		do_fire,	POS_STANDING,	 2,  LOG_NORMAL },
    ...
    { "gnosis", 	do_gnosis, 	POS_SLEEPING,    3,  LOG_NORMAL },
    { "hqedi",    	do_hqedi,   	POS_STANDING,    3,  LOG_ALWAYS },
    { "hqedit",   	do_hqedit,  	POS_STANDING,    3,  LOG_ALWAYS },
    { "highlander",     do_highlander,  POS_DEAD, 	 1,  LOG_NORMAL },
    { "highskills",     do_highskills,  POS_SITTING, 	 1,  LOG_NORMAL },
    { "hire",		do_hire,	POS_STANDING,	 3,  LOG_ALWAYS },
    ...
    { "inconn",		do_inconn,	POS_STANDING,	 3,  LOG_NORMAL },
    ...
    { "magearmour",     do_magearmour,  POS_DEAD,        2,  LOG_ALWAYS },
    ...
    { "retire",		do_retire,	POS_STANDING,	 2,  LOG_NORMAL },
    ...
    { "disable", 	do_disable,	POS_DEAD,	 8,  LOG_ALWAYS },
    ...
    { "noemote",	do_noemote,	POS_DEAD,	 9,  LOG_ALWAYS	},
    { "notell",		do_notell,	POS_DEAD,	 9,  LOG_ALWAYS	},
    ...
    { "parado",		do_parado,	POS_DEAD,	10,  LOG_NORMAL },
    ...
    { "ienter",		do_ienter,	POS_DEAD,	 2,  LOG_ALWAYS },
    { "iexit",		do_iexit,	POS_DEAD,	 2,  LOG_ALWAYS },
    { "echo",		do_echo,	POS_DEAD,	 8,  LOG_ALWAYS	},
    { "goto",		do_goto,	POS_DEAD,	 7,  LOG_NORMAL	},
    { "holylight",	do_holylight,	POS_DEAD,	 7,  LOG_NORMAL	},
    { "incog",          do_incog,       POS_DEAD,        8,  LOG_NORMAL },
    { "invis",		do_invis,	POS_DEAD,	 8,  LOG_NORMAL	},
    ...
    { "pstat", 		do_pstat,	POS_DEAD,	 7,  LOG_NORMAL },
...
const	struct	social_type	social_table [] =
{
	...
	"You scowl angrily.",
	"$n scowls angrily.",
	"You scowl angrily at $M.",
	"$n scowls angrily at $N.",
	"$n scowls angrily at you.",
	"You scowl angrily at yourself.",
	"$n scowls angrily at $mself."
    },
...
/*  ROOMTEXT_DATA *rt;
     ...
     */
    found = FALSE;
    trust = IS_IMMORTAL(ch) ? get_trust( ch ) : ch->level;
	...
	&&   cmd_table[cmd].level <= trust )
	{
	    ...
	    else if (IS_AFFECTED(ch, AFF_TIED))
	    {
		if      (!str_cmp( cmd_table[cmd].name, "say"  )) found = TRUE;
		else if (!str_cmp( cmd_table[cmd].name, "'"    )) found = TRUE;
		else if (!str_cmp( cmd_table[cmd].name, "chat" )) found = TRUE;
 ...
 */
                ...
                else if (!str_cmp( cmd_table[cmd].name, "force" )) found = TRUE;
	...
	log_string( log_buf, LOG_INTERPRET );
    }
...
void do_disable (CHAR_DATA *ch, char *argument)
{
	...
	else /* not a disabled command, check if that command exists */
	{
		...
		if (!str_cmp(cmd_table[i].name, argument)) break;

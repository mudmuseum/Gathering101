 ...
 */
	...
	&gsn_call_lightning,	SLOT( 6),	15,	12,
	...
	&gsn_shocking_grasp,	SLOT(37),	15,	12,
 ...
 */
	...
	&gsn_fire_breath,	SLOT(201),	 50, 	12,
	...
	&gsn_lightning_breath,	SLOT(204),	50, 	12,
    ...
    },
    {
        ...
        NULL,        SLOT(206),           15,     12,
        "Combat Mind",                     "Your battle sense has faded.",
    },

    {
        "complete healing",     12,
        spell_complete_healing, TAR_CHAR_SELF,          POS_STANDING,
        NULL,         SLOT(207),          1000,    12,
        "",                     "!Complete Healing!",
    },
...

    {
        ...
        &gsn_hold_person, SLOT(209), 2500, 24,
        "spell", "Your containment dissipates and releases you.",
    },

    {
        "speed",               1,
        spell_speed, TAR_CHAR_SELF, POS_STANDING,
        &gsn_speed, SLOT(209), 25, 12,
        "speeds up", "Your molecules slow back to normal speed.",
    },

    {
      "animate dead",         4,
      spell_animate_dead,     TAR_OBJ_ROOM,     POS_STANDING,
      NULL,   SLOT(215),        5,     12,
       "",                     "!Animate Dead!",
    },
 ...
 */
	...
	"tied",			99,
	spell_null,		TAR_CHAR_SELF,	POS_STANDING,
	&gsn_tied,		SLOT( 94),	 5,	12,
	NULL,			"The ropes binding you loosen."
    }
